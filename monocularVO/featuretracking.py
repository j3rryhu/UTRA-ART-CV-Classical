...
def feature_tracking(image1, image2, corners1, corners2):
    ...
    corners2, status, err = cv2.calcOpticalFlowPyrLK(image1, image2, corners1, None, **dict(winSize=(21, 21), criteria=(cv2.TERM_CRITERIA_EPS | cv2.TERM_CRITERIA_COUNT, 30, 0.01)))
